      ...
      try {
        ...
        workbook.SheetNames.forEach((sheetName) => {
          ...
          const updateUploadedExcelData =
            useUploadedExcelStore.getState().updateUploadedExcelData;
          ...
          switch (sheetName.trim().toLowerCase()) {
            case "standard rate (rm)": {
              standardRateRawData = this.readStandardRate(jsonData);
              const tempObject =
              ...
              standardRateTable.tNcCode = standardRateRawData.tNcCode;
              standardRateTable.standardRateCompactSet = standardRateCompact;
              ...
              const updatestandardRateCompactData =
                useStandardRateStore.getState().updatestandardRateCompactData;
              updatestandardRateCompactData(standardRateTable);

              const updateStandardRateOneLineData =
                useStandardRateStore.getState().updateStandardRateOneLineData;
