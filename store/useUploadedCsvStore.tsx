...
interface UploadedSheetState {
  ...
  sheetFormulaData: ParsedStandardRateData[];
  sheetFormulaRowData: ParsedStandardRateRowData[];
...
const useUploadedCsvStore = create<UploadedSheetState>((set, get) => ({
              ...
              let tempStandardRateRowData = {
                ...
                effectiveDate:
                  tempSheetData.realData[j].byWeightBreak[
                    tempSheetData.realData[j].byWeightBreak.length - 2
                  ],
              };
  ...
  castSheetStandardRateFormulaDataToSheetRowData: () => {
    set((state) => {
        ...
        if (
          ...
          for (let j = 0; j < tempSheetData.realData.length; j++) {
            for (let k = 0; k < state.sheetData[i].bySolution.length; k++) {
              ...
              // Debug
              // console.log(tempStandardRateFormulaRowData);
            }
          }
        }
      }
      ...
      // Debug
      console.log(standardRateFormulaRowDataArray);

      // Update state without returning
      return {
        ...state,
        sheetRowData: standardRateFormulaRowDataArray,
      };
    });
  },
