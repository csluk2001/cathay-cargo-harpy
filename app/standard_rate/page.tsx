...
const columns: ColumnDef<ParsedStandardRateWithFormulaRowData>[] = [
	{
		accessorKey: "origin",
		header: ({ column }) => {
			return (
	...
	},
	{
		...
		cell: ({ row }) => <div>{row.getValue("translatedFormula")}</div>,
	},
	{
		...
		cell: ({ row }) => <div>{row.getValue("effectiveDate")}</div>,
	},
	{
		id: "actions",
		enableHiding: false,
...
import { ParsedStandardRateWithFormulaRowData } from "@/types/ParsedCsvData";
